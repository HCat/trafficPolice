...
#define USERDEFAULT_KEY_USERTYPE @"USERDEFAULT_KEY_USERTYPE"
#define USERDEFAULT_KEY_TOKEN @"USERDEFAULT_KEY_TOKEN"
#define USERDEFAULT_KEY_PHONE @"USERDEFAULT_KEY_PHONE"
#define USERDEFAULT_KEY_SEARCHTAG @"USERDEFAULT_KEY_SEARCHTAG"
